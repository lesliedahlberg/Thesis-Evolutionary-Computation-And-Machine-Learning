%[minSphere, iterSphere, foundSphere] = EDA(@Sphere, [-5.12, 5.12], 0.1, 100, 100000, 10)
%[minRosenbrock, iterRosenbrock, foundRosenbrock] = EDA(@Rosenbrock,[-2.048, 2.048], 0.01, 100, 1000, 2)
%[minRastrigin, iterRastrigin, foundRastrigin] = EDA(@Rastrigin, [-5.12,5.12], 0.000001, 100, 1000,10)
[minGriewank, iterGriewank, foundGriewank] = EDA(@Griewank, [-40,40], 0.000001, 100, 10000, 5)
%[minAckley, iterAckley, foundAckley] = EDA(@Ackley, [-5, 5],0.000001, 100, 10000, 2)
%[minShekel, iterShekel, foundShekel] = EDA(@ShekelsFoxholes, [-65.536, 65.536], 0.998005, 100, 10000, 20)
